      ...
      <div className="form-control px-5 py-4">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {selectedCustomers.map((cust) => (
            <div
              key={cust.Id}
              className="flex items-center justify-center rounded-full bg-slate-50 px-3 py-1 text-sm text-slate-800 shadow-sm"
            >
              <span>{cust.Name}</span>
              <button
                className="ml-2  text-lg font-medium text-red-500 hover:text-red-700"
                onClick={() =>
